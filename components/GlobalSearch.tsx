...
const STATIC_LINKS: Record<string, SearchResult[]> = {
  ...
  company: [
    ...
    { id:'6', title:'Profili i biznesit', subtitle:'Edito kompaninë',              icon:'🏢', href:'/company/profile',         category:'Llogaria' },
    { id:'7', title:'Cilësimet',          subtitle:'Fjalëkalim, email',             icon:'⚙️', href:'/company/settings',        category:'Llogaria' },
    { id:'8', title:'Premium',            subtitle:'Shiko planet e abonimit',       icon:'💎', href:'/pricing',                 category:'Llogaria' },
  ],
  worker: [
    ...
    { id:'5', title:'Vlerësimet',         subtitle:'Ndërtoji reputacionin',        icon:'⭐', href:'/worker/reviews',          category:'Navigim' },
    { id:'6', title:'Profili im',         subtitle:'Edito profilin profesional',   icon:'👤', href:'/worker/profile',          category:'Llogaria' },
    { id:'7', title:'Cilësimet',          subtitle:'Fjalëkalim, email',            icon:'⚙️', href:'/worker/settings',         category:'Llogaria' },
    { id:'8', title:'Premium',            subtitle:'Gjej më shumë punë',           icon:'💎', href:'/pricing',                 category:'Llogaria' },
  ],
  admin: [
